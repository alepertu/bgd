      ...
      <main>
        <Section id="inicio">
          <div className="relative h-1/2 flex flex-col place-content-end gap-2">
            ...
            <p className="text-lg mt-6 mb-10 tracking-tight leading-6 text-balance">
            ...
            <a
              className="bg-black py-2 px-4 text-xl rounded no-underline w-2/3 mx-auto text-white font-semibold border-2 border-transparent hover:text-black transition-all hover:bg-transparent hover:border-black"
              href="#contacto">
              Contános tu idea
            </a>
          </div>
