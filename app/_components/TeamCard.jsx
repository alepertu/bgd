...
export default function TeamCard({
  ...
  if (isEmpty) {
    return (
      <div className="bg-gray-100 rounded-2xl w-full max-w-sm text-left flex flex-col items-start overflow-hidden group hover:shadow-lg transition-shadow duration-300">
  ...
  return (
    <div className="bg-gray-100 rounded-2xl w-full max-w-sm text-left flex flex-col items-start overflow-hidden group hover:shadow-lg transition-shadow duration-300">
      <Image
        src={image}
        alt={altText}
        className="w-full h-64 md:h-80 object-cover rounded-t-2xl transition-transform duration-500 group-hover:scale-105"
        width={320}
        height={320}
      />
      <div className="p-4 md:p-6">
