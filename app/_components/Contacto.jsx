...
function Contacto() {
  return (
    <section className="bg-[#a5c8d8] p-6 py-12 md:p-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              <div className="flex flex-col gap-4 md:col-span-2">
                <input
                  type="text"
                  placeholder="Nombre"
                  className="p-3 border rounded-3xl w-full placeholder-[#a5c8d8]"
                />
                <input
                  type="text"
                ...
                <input
                  ...
                  className="p-3 border rounded-3xl w-full placeholder-[#a5c8d8]"
                />
                <select className="p-3 border rounded-3xl w-full text-[#a5c8d8]">
              ...
              <div className="flex flex-col gap-4 h-full flex-1 md:col-span-3">
                ...
                <textarea
                  ...
                  className="p-3 border rounded-3xl w-full h-40 md:h-32 box-border placeholder-[#a5c8d8]"
                ></textarea>
              </div>
            </div>
            <button className="bg-gray-900 text-white py-3 px-12 rounded-3xl mt-4 w-full md:w-auto">
              ¡Enviar idea!
            </button>
          </form>
        </div>
          ...
          <div className="contactos flex flex-col gap-6">
            ...
            <span className="flex items-center gap-4 text-lg">
              <a
                ...
                rel="noreferrer"
              >
                <FaInstagram className="text-4xl text-gray-900" />
              </a>
              @pya.dev
            </span>
          </div>
